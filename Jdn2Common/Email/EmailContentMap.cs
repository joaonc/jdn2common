...
namespace Jdn2Common.Email
{
    ...
    public class EmailContentMap
    {
        ...
        {
            return (EmailContent)Jdn2Common.Util.DeserializeFromXmlFile(fileName, typeof(EmailContent));
        }

        public static void SaveEmailContent(CultureInfo cultureInfo, EmailContentType emailContentType, EmailContent emailContent)
        {
            Jdn2Common.Util.SerializeToXmlFile(emailContent, GetFileName(cultureInfo, emailContentType));
        }
